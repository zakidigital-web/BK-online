...
export default function AdminCurhatPage() {
  ...
  return (
    <div className="space-y-4 pb-20 md:pb-0">
      ...
      {/* Mobile: list or chat, never both */}
      <div className="block lg:hidden">
        {selectedId ? (
          <div className="space-y-3">
            <Button variant="ghost" size="sm" onClick={() => { setSelectedId(null); setFilteredMessages([]) }}>
              ← Kembali ke daftar
            </Button>
            <Card className="border-0 shadow-sm">
              <CardHeader className="pb-2">
                <CardTitle className="text-base truncate">
                  Percakapan dengan <code className="text-violet-700">{selectedId}</code>
                </CardTitle>
              </CardHeader>
              <CardContent>
